...
// configuration step. It creates a namespace called `snake_engine`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", snake_engine::cmake::project_name, snake_engine::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", snake_engine::cmake::project_version);
      return EXIT_SUCCESS;
    }
